...
const PROJECTS = [
  ...
  {
    title: "Rest Assured Project",
    subtitle: "API Testing with Rest Assured",
    year: "2026",
    description: "API testing framework using Rest Assured for a publically available API collection.",
    tech: ["Rest Assured", "Java", "Maven", "Extend Report", "TestNG"],
    github: "https://github.com/Dasun169/rest-assured-project.git",
    linkedin: "https://www.linkedin.com/posts/dasun-navindu-987857292_qa-automationtesting-apitesting-ugcPost-7474054678708895744-N3_Z/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAEb2CbcBNBM25m8IGdkMoIfZj_OeRz--geQ",
    demo: null,
  ...
  },
  {
    ...
    demo: null,
    color: "from-black-500/20 to-orange-500/20",
